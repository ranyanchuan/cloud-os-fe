...
const { setMenuKeys } = wrapActions;
import { sideBar, sideBarList, sideBarListItem, last_item, item1_text, item2_text, dot, menuContainer, workbenchClass } from './style.css';
...
class MenuBarInner extends Component {
	...
	componentWillReceiveProps(nextProps) {
		if (nextProps.allMenuList.length && !this.props.allMenuList.length) {
			this.rendList(nextProps.allMenuList);
		}
	}
