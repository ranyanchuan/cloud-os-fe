...
let iconFontPath = path.resolve(__dirname, '../en_US/css/iconfont');
if(!iconFontPath){
...
let assetsPath = path.resolve(__dirname, '../en_US/assets2');
if(!assetsPath){
...
// let staticPath = path.resolve(__dirname, '../en_US/static');
// if(!staticPath){
...
let mainZhPath = path.resolve(__dirname , '../en_US/css/main.css'); 
