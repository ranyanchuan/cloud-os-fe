...
const defaultState = {
	...
	themeList: [
		...
		{ id: "paleblue", background: "linear-gradient(180deg,rgba(177,189,197,1) 0%,rgba(203,209,210,1) 100%)", color: "#333333", editColor: "#505766", name: "淡雅藍" },
		{ id: "yellow", background: "linear-gradient(180deg,rgba(208,202,191,1) 0%,rgba(237,235,232,1) 100%)", color: "#333333", editColor: "#505766", name: "莫蘭迪黃" },
		{ id: "blue", background: "linear-gradient(359deg,rgba(105,111,124,1) 0%,rgba(65,76,90,1) 100%)", color: "#ffffff", editColor: "#ffffff", name: "星空藍" },
	],
	helpInfo: {},
};
