...
class InfoContent extends Component {
	constructor(props) {
		...
		this.state = {
			desktop: [
				{ key: 'workbench', text: '工作台', icon: 'computer' },
				{ key: 'portal', text: '門戶', icon: 'home' },
			],
	...
	render() {
		...
		const developText = isDevelopCookie ? "關閉錄製" : "開啟錄製";
		return (
			<div className={info}>
				{
							...
							<dd>
								<ul>
									<li onClick={this.openAccount}>
										<div className={list}>
											<Icon type="account-management" />
											<span title="帳號管理">帳號管理</span>
										</div>
									</li>
									<li onClick={this.openLang}>
										<div className={list}>
											<Icon type="language" />
											<span title="我的首選">我的首選</span>
										</div>
									</li>
									{
