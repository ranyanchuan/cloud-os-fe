...
var MylocaleList=__webpack_require__(98);var echart=__webpack_require__(99);var SERVER_URL='https://u8cacc-daily.yyuap.com';var AssetLiabilityAnalysis=function(_Component){__WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(AssetLiabilityAnalysis,_Component);function AssetLiabilityAnalysis(props){__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this,AssetLiabilityAnalysis);var _this2=__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(this,(AssetLiabilityAnalysis.__proto__||__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_get_prototype_of___default()(AssetLiabilityAnalysis)).call(this,props));_this2.getData=function(){var _this=_this2;var url=SERVER_URL+"/fids/digitalExperience/queryAssetDebtData";var xhr=_this2.createCORSRequest('POST',url);if(!xhr){console.log('CORS not supported');return;}var params={};xhr.onreadystatechange=function(){if(xhr.readyState===4&&xhr.status===200){var responseData=JSON.parse(xhr.responseText);var success=responseData.success;if(success){_this.setState({responseData:responseData},function(){_this.renderEchart();});}}};xhr.setRequestHeader('Content-Type','application/json');xhr.send(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(params));};_this2.createCORSRequest=function(method,url){var xhr=new XMLHttpRequest();if("withCredentials"in xhr){xhr.withCredentials=true;xhr.open(method,url,true);}else if(typeof XDomainRequest!="undefined"){xhr=new XDomainRequest();xhr.open(method,url);}else{xhr=null;}return xhr;};_this2.reLoad=function(e){e.preventDefault();e.stopPropagation();_this2.getData();};_this2.renderEchart=function(){_this2.echartLine.setOption({color:['#00B59E','#FBAE49','#E34B41','#27A9E3','#6558E7'],title:{text:'',subtext:'',x:'center'},tooltip:{trigger:'item',formatter:"{b} : {c} ({d}%)",textStyle:{fontWeight:400,fontSize:12}},legend:{itemHeight:6,itemWidth:6,orient:'vertical',bottom:'0',right:"0",data:_this2.state.dataX,icon:'circle',textStyle:{fontWeight:400,fontSize:9,color:'#333333'}},labelLine:{normal:{lineStyle:{color:'#CCCCCC'},smooth:0.2}},series:[{name:'',type:'pie',radius:'65%',center:['40%','60%'],label:{normal:{formatter:' {b|{b}}\n   {per|{d}%}  ',rich:{per:{fontSize:8,color:'#666666'}},position:'right',textStyle:{fontWeight:300,fontSize:9}}},data:_this2.state.dataY,itemStyle:{emphasis:{shadowBlur:10,shadowOffsetX:0,shadowColor:'rgba(0, 0, 0, 0.5)'}}}]});};_this2.state={responseData:null,dataX:null,dataY:null,locale:'zh_CN'};if(typeof window.diworkContext==='function'){var _window$diworkContext=window.diworkContext(),locale=_window$diworkContext.locale;_this2.state.locale=locale;}_this2.mylocaleList=MylocaleList[_this2.state.locale];return _this2;}__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(AssetLiabilityAnalysis,[{key:'componentWillMount',value:function componentWillMount(){var localAddress=window.location.host;if(localAddress.includes("pre")){SERVER_URL="https://acc-y3me-pre.diwork.com";}else if(localAddress.includes("daily")){SERVER_URL='https://u8cacc-daily.yyuap.com';}else if(localAddress.includes("test")){SERVER_URL='http://u8cacc-test.yyuap.com';}this.getData();}},{key:'componentDidMount',value:function componentDidMount(){var _this3=this;this.echartLine=echart.echarts.init(document.getElementById('asset_liability_analysis'));if(this.state.responseData&&this.state.responseData.dataX&&this.state.responseData.dataY){var dataX=this.state.responseData.dataX.length>5?this.state.responseData.dataX.splice(0,4):this.state.responseData.dataX;var dataY=this.state.responseData.dataY.length>5?this.state.responseData.dataY.splice(0,4):this.state.responseData.dataY;this.setState({dataX:dataX,dataY:dataY},function(){_this3.renderEchart();});}else{var _dataX=["其他非流动资产","预付款项","货币资金","应收票据","交易性金融资产"];var _dataY=[{"name":"其他非流动资产","value":1},{"name":"预付款项","value":2},{"name":"货币资金","value":3},{"name":"应收票据","value":4},{"name":"交易性金融资产","value":5}];this.setState({dataX:_dataX,dataY:_dataY},function(){_this3.renderEchart();});}}},{key:'clickHandler',value:function clickHandler(){Object(__WEBPACK_IMPORTED_MODULE_10_widgetTool__["dispatch"])('openService',{serviceCode:__WEBPACK_IMPORTED_MODULE_9_widgetInstance__["serviceCode"]});}},{key:'render',value:function render(){return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:__WEBPACK_IMPORTED_MODULE_8__index_css__["wrap"],onClick:this.clickHandler},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:__WEBPACK_IMPORTED_MODULE_8__index_css__["titleContainer"]},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:__WEBPACK_IMPORTED_MODULE_8__index_css__["title"]},this.mylocaleList['资产负债分析'])),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{id:'asset_liability_analysis',className:__WEBPACK_IMPORTED_MODULE_8__index_css__["echartContainer"]}),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('a',null,__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('img',{className:__WEBPACK_IMPORTED_MODULE_8__index_css__["svg"],src:__WEBPACK_IMPORTED_MODULE_7__download_svg___default.a,onClick:this.reLoad}))));}}]);return AssetLiabilityAnalysis;}(__WEBPACK_IMPORTED_MODULE_6_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (AssetLiabilityAnalysis);
...
// module
exports.push([module.i, ".scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__wrap--tDmDZ{position:absolute;margin-top:-42px;width:360px;height:176px;background:#fff;box-shadow:0 1px 1px 0 rgba(74,81,93,.1);border-radius:3px;overflow:hidden}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__titleContainer--2qlyz{display:-webkit-box}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__title--2t3g8{-webkit-box-flex:1.0;-webkit-box-pack:start;padding-left:8px}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__title--2t3g8,.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__title_right--2KZD6{margin-top:14px;line-height:21px;font-size:16px;color:#111;font-family:tahoma,Hiragino Sans GB,arial,Heiti SC,Microsoft YaHei,\"sans-serif\"}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__title_right--2KZD6{-webkit-box-pack:end;margin-right:10px;height:28px;width:165px;border:1px solid #111}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__year_quarter_month--3kzaP{width:54px;border-right:1px solid #111;float:left;line-height:28px;text-align:center}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__year_quarter_month--3kzaP:last-child{border-right-width:0}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__echartContainer--18Ngv{height:134px;font-size:7.91px}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__echartContainer--18Ngv canvas{cursor:pointer}.scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__svg--2aDWV{width:16px;height:19px;cursor:pointer;opacity:.4;position:absolute;left:9px;bottom:5px}", ""]);

// exports
exports.locals = {
	"wrap": "scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__wrap--tDmDZ",
	"titleContainer": "scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__titleContainer--2qlyz",
	"title": "scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__title--2t3g8",
	"title_right": "scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__title_right--2KZD6",
	"year_quarter_month": "scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__year_quarter_month--3kzaP",
	"echartContainer": "scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__echartContainer--18Ngv",
	"svg": "scripts-fbe84159-5bce-4dc7-af0a-6fbc3739e74e-index__svg--2aDWV"
};
...
module.exports={en_US:{'资产负债分析':'Asset and liability analysis',MonthShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]},zh_TW:{'资产负债分析':'资产负债分析',MonthShort:["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"]},zh_CN:{'资产负债分析':'资产负债分析',MonthShort:["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"]}};
