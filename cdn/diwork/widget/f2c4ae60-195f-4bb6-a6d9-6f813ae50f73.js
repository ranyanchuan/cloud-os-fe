...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_widgetContext__ = __webpack_require__(93);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__hosts_js__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__refresh_svg__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__refresh_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__refresh_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__loading_svg__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__loading_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__loading_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_widgetInstance__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_widgetInstance___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_widgetInstance__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_widgetTool__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_widgetTool___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_widgetTool__);
var evn=__WEBPACK_IMPORTED_MODULE_8__hosts_js__["a" /* default */][window.diworkContext().profile];var getCookie=function getCookie(name){var arr=void 0,reg=new RegExp("(^| )"+name+"=([^;]*)(;|$)");if(arr=document.cookie.match(reg))return unescape(arr[2]);else return null;};var PHPSESSID='';var qzId='';var Widget=function(_Component){__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default()(Widget,_Component);function Widget(props){__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this,Widget);var _this=__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this,(Widget.__proto__||__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(Widget)).call(this,props));var lang={unReadWemail:'待办任务',loading:'读取中'};switch(window.diworkContext().locale){case'zh_CN':lang={unReadWemail:'待办任务',loading:'读取中'};break;case'en_US':lang={unReadWemail:'To-do',loading:'Reading…'};break;case'zh_TW':lang={unReadWemail:'待辦任務',loading:'讀取中'};break;default:lang={unReadWemail:'待办任务',loading:'读取中'};}_this.state={num:'',isLoadingShow:false,lang:lang};_this.getUserCode=_this.getUserCode.bind(_this);_this.getToken=_this.getToken.bind(_this);return _this;}__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Widget,[{key:'componentDidMount',value:function componentDidMount(){var _this2=this;setTimeout(function(){PHPSESSID=getCookie('PHPSESSID');_this2.getUserCode();},1000);}},{key:'getUserCode',value:function getUserCode(){var _this3=this;fetch(evn.host+'/user/userCode?v=1',{method:'GET',credentials:'include'}).then(function(response){return response.json();}).then(function(response){if(response.code!=0){return;}var data=response.data;qzId=data.qz_id;_this3.getToken();});}},{key:'getUnreadCount',value:function getUnreadCount(token){var _this4=this;fetch(evn.task+'/task/task/getTaskListForAssembly?queryList=0&token='+token+'&sessionid='+PHPSESSID+'&qzId='+qzId,{method:'GET',credentials:'include'}).then(function(response){return response.json();}).then(function(response){if(response.code!=0){return;}var showNum=response.data.totalMagnet;if(showNum>0&&showNum<10){showNum=0+showNum.toString();}else if(showNum>999){showNum='999';}_this4.setState({num:response.data.totalMagnet,isLoadingShow:false,showNum:showNum});});}},{key:'getToken',value:function getToken(event){var _this5=this;event&&event.stopPropagation();if(!PHPSESSID){return;}this.setState({isLoadingShow:true});fetch(evn.task+'/task/index/login/bySessionId?sessionId='+PHPSESSID,{method:'GET',credentials:'include'}).then(function(response){return response.json();}).then(function(response){if(response.code!=0){return;}_this5.getUnreadCount(response.data.token);});}},{key:'toAgenda',value:function toAgenda(){Object(__WEBPACK_IMPORTED_MODULE_12_widgetTool__["dispatch"])('openService',{serviceCode:'XTRENWU00000000000'});}},{key:'render',value:function render(){var _this6=this;return __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('div',{className:__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.tileHouseItem,onClick:this.toAgenda},__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('div',{className:__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.tileCount},__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('div',null,this.state.showNum,__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('i',{className:this.state.num>999?__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.show:__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.hidden},'...')),__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('div',null,this.state.lang.unReadWemail)),__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('a',{className:__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.refresh,onClick:function onClick(event){_this6.getToken(event);}},__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('img',{className:__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.refreshImg,src:__WEBPACK_IMPORTED_MODULE_9__refresh_svg___default.a})),__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('div',{className:[__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.loading,this.state.isLoadingShow?__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.show:__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.hidden].join(' ')},__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('img',{className:__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.loadingIcoin,src:__WEBPACK_IMPORTED_MODULE_10__loading_svg___default.a}),__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('div',{className:__WEBPACK_IMPORTED_MODULE_6__index_css___default.a.loadingText},this.state.lang.loading,'\u2026')));}}]);return Widget;}(__WEBPACK_IMPORTED_MODULE_5_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Widget);
...
// module
exports.push([module.i, ".scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__tileHouseItem--jARV-{position:relative;text-align:center;width:176px;height:134px;float:left;box-sizing:border-box;padding:9px;cursor:pointer}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__tileTitle--1TUh7{margin:5px 0}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__tileCount--1Pzm8 div:first-of-type{margin-top:8px;color:#474d54;font-size:52px;line-height:61px;height:61px}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__tileCount--1Pzm8 div:last-of-type{color:#9b9fa1;font-size:12px}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__refresh--fj1-X{position:absolute;left:7px;bottom:7px;width:16px;height:16px;transform:rotateX(180deg);cursor:pointer}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__refreshImg--2Gvmz{display:block;width:16px;height:16px;opacity:.29}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__toDetail--1HL28{position:absolute;right:9px;bottom:9px;font-size:12px;color:#b0b0b0;cursor:pointer;text-decoration:none}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__show--3Y5PQ{display:block}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__hidden--Euf9J{display:none}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loading--3vsmx{position:absolute;left:0;top:0;width:176px;height:176px;background:#fff}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loading--3vsmx .scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loadingIcoin--xlf0T{display:block;position:absolute;left:72px;top:72px;width:32px;height:32px;transform-origin:center center;animation:scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loadingAnim--11M0S 1.5s infinite linear}.scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loading--3vsmx .scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loadingText--3amY8{position:absolute;left:9px;bottom:4px;font-size:14px;color:#888}", ""]);

// exports
exports.locals = {
	"tileHouseItem": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__tileHouseItem--jARV-",
	"tileTitle": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__tileTitle--1TUh7",
	"tileCount": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__tileCount--1Pzm8",
	"refresh": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__refresh--fj1-X",
	"refreshImg": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__refreshImg--2Gvmz",
	"toDetail": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__toDetail--1HL28",
	"show": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__show--3Y5PQ",
	"hidden": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__hidden--Euf9J",
	"loading": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loading--3vsmx",
	"loadingIcoin": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loadingIcoin--xlf0T",
	"loadingAnim": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loadingAnim--11M0S",
	"loadingText": "scripts-f2c4ae60-195f-4bb6-a6d9-6f813ae50f73-index__loadingText--3amY8"
};
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = ({test:{host:'//dwweb.api.yyuap.com:6062',task:'//123.103.9.204:6058'},daily:{host:'//dwweb-api.yyuap.com',task:'//ezone-daily.yyuap.com'},combine:{host:'//dwweb-api-u8c-daily.yyuap.com',task:'//ezone-u8c-daily.yyuap.com'},online:{host:'//dwweb-api.diwork.com',task:'//ezone.diwork.com'}});
